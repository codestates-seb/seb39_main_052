...
.http-request
include::{snippets}/recipe-create/http-request.adoc[]

.request-fields
include::{snippets}/recipe-create/request-fields.adoc[]
...
.path-parameters
include::{snippets}/recipe-update/path-parameters.adoc[]

.http-request
include::{snippets}/recipe-update/http-request.adoc[]

.request-fields
include::{snippets}/recipe-update/request-fields.adoc[]
